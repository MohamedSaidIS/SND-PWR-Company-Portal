...
import 'package:company_portal/screens/account/support/complaint_suggestion/complaint_suggestion_screen.dart';
import 'package:company_portal/screens/account/support/dynamics_support_case/dynamics_support_case_screen.dart';
import 'package:company_portal/screens/account/support/ecommerce_support_case/ecommerce_support_case_screen.dart';
import 'package:company_portal/screens/account/support/user_new_requests/user_new_request_screen.dart';
...
class _SupportScreenState extends State<SupportScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (!ensureUserProvider.loading && ensureUserProvider.error == null) {
      AppNotifier.logWithScreen("Support Screen",
